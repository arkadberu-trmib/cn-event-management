...
export function Portfolio() {
  ...
  const images = [
    { src: "/images/portfolio1.jpg.jpg", alt: "Birthday Celebration", colSpan: "md:col-span-1", rowSpan: "md:row-span-1" },
    { src: "/images/portfolio2.jpg.JPG", alt: "Wedding Sparkler Exit", colSpan: "md:col-span-1", rowSpan: "md:row-span-2" },
    { src: "/images/portfolio3.jpg.JPG", alt: "Dance Floor Party Event", colSpan: "md:col-span-1", rowSpan: "md:row-span-1" },
  ];
