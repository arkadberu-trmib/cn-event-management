  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-16 flex flex-col items-start mt-20">
        ...
        >
          We create unforgettable events that feel effortlessly elegant and timelessly refined. Let Nina and Char bring your vision to life.
        </motion.p>
        ...
        >
          ...
          <a href="#quote" className="w-full sm:w-auto flex items-center justify-center gap-2 font-medium text-white hover:text-white/80 transition-colors">
